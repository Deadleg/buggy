	    ...
	    render: function () {
	        ...
	        var summaries = this.state.popular.map((summary, index) => {
	            var issues = summary.topIssues.map((issue, index2) => {
	                return (React.createElement("div", {key: index2, className: "row"}, React.createElement("span", {className: "card-text col-sm-10"}, React.createElement(react_router_1.Link, {to: "/app/" + summary.id + "/issue/" + issue.issueId}, issue.title)), React.createElement("div", {className: "col-sm-2 align-right"}, issue.upvotes)));
	            });
	            return (React.createElement("div", {className: "col-sm-3"}, React.createElement("div", {className: "card card-light"}, React.createElement("img", {src: "http://cdn.akamai.steamstatic.com/steam/apps/730/header.jpg?t=1452221296", className: "img-fluid card-img-top"}), React.createElement("div", {className: "card-block"}, React.createElement("h4", {className: "card-title"}, React.createElement(react_router_1.Link, {to: "/app/" + summary.id + "/issue"}, summary.name)), issues))));
	        });
	        return (React.createElement("div", null, React.createElement("div", {className: "container"}, React.createElement("h2", {className: "bottom-margin-md"}, "Hot issues"), React.createElement("div", {className: "row"}, popularIssues)), React.createElement("div", {className: "banner"}, React.createElement("div", {className: "container"}, React.createElement("div", {className: "banner-body"}, React.createElement("h2", {className: "bottom-margin-md"}, "Popular games"), React.createElement("div", {className: "row"}, summaries))))));
	    }
	});
	ReactDOM.render((React.createElement(react_router_1.Router, {history: react_router_1.browserHistory}, React.createElement(react_router_1.Route, {component: Layout}, React.createElement(react_router_1.Route, {path: "/", component: Home}), React.createElement(react_router_1.Route, {path: "/account/login", component: login_1.Login}), React.createElement(react_router_1.Route, {path: "/app/:programId", component: program_1.Program}, React.createElement(react_router_1.Route, {path: "/app/:programId/issue/new", component: create_issue_1.CreateIssue}), React.createElement(react_router_1.Route, {path: "/app/:programId/issue/:issueId/edit", component: edit_issue_1.EditIssue}), React.createElement(react_router_1.Route, {path: "/app/:programId/issue/:issueId", component: issue_1.Issue}), React.createElement(react_router_1.Route, {path: "/app/:programId/issue/:issueId/report/new", component: create_issue_report_1.CreateIssueReport}), React.createElement(react_router_1.Route, {path: "/app/:programId/issue/:issueId/report/:reportId", component: issue_report_1.IssueReport}), React.createElement(react_router_1.Route, {path: "/app/:programId/issue/:issueId/report/:reportId/comments/new", component: create_issue_report_comment_1.CreateIssueReportComment}), React.createElement(react_router_1.Route, {path: "/app/:programId/issue/:issueId/comments/new", component: create_issue_comment_1.CreateIssueComment}), React.createElement(react_router_1.Route, {path: "/app/:programId/issue", component: issues_1.Issues}))))), document.getElementById('content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	const react_tabs_1 = __webpack_require__(67);
	class Issue extends React.Component {
	    ...
	    render() {
	        ...
	        var reports = this.state.reports.map(function (report, index) {
	            ...
	            return (React.createElement("div", {key: index, className: "col-sm-4", style: { "marginBottom": "1rem" }}, React.createElement("div", {style: { "marginBottom": "1rem" }}, React.createElement("div", {className: "card"}, React.createElement("div", {className: "card-block"}, React.createElement("div", null, report.description), React.createElement("p", null, report.specs), React.createElement("div", {className: "label-group"}, React.createElement("div", {className: "label label-default"}, report.status), React.createElement("div", {className: "label label-default"}, report.type), React.createElement("div", {className: "label label-default"}, report.confirmed ? "Confirmed" : "Unconfirmed")), React.createElement("div", null, React.createElement("small", null, "Reported by ", report.reporter.username)), React.createElement("div", null, React.createElement("small", null, "At ", report.time)), React.createElement("div", {className: "btn-group-spaced", style: { "marginBottom": "1rem" }}, React.createElement("button", {className: "btn btn-common", onClick: self.markReportAsFixed.bind(self, index)}, "Mark as fixed"), React.createElement("div", {className: "btn btn-common"}, React.createElement(react_router_1.Link, {to: "/app/" + self.props.params.programId + "/issue/" + self.props.params.issueId + "/report/" + report.id}, "Comments"))))))));
	        });
	        var edited;
	        if (this.state.issue.lastEdited) {
	            edited = React.createElement("div", null, React.createElement("small", null, "Edit time: ", this.state.issue.lastEdited));
	        }
	        return (React.createElement("div", {className: "container"}, React.createElement("div", {className: "row"}, React.createElement("div", {className: "col-sm-6"}, React.createElement("h3", null, this.state.issue.title), React.createElement("div", {className: "label-group", style: { "marginBottom": "1rem" }}, React.createElement("span", {className: "label label-default"}, this.state.issue.type), React.createElement("span", {className: "label label-default"}, this.state.issue.status)), React.createElement("div", null, this.state.issue.description))), React.createElement("div", {className: "row"}, React.createElement("div", {className: "col-sm-6"}, React.createElement("ol", {className: "common-list"}, steps))), React.createElement("div", {className: "row"}, React.createElement("div", {className: "col-sm-6"}, React.createElement("div", null, React.createElement("small", null, "Reported by: ", this.state.issue.reporter.username)), React.createElement("div", null, React.createElement("small", null, "At ", this.state.issue.time)), edited)), React.createElement("div", {className: "row", style: { "marginTop": "2rem", "marginBottom": "2rem" }}, React.createElement("div", {className: "col-sm-12 btn-group-spaced", id: "issueTabs"}, React.createElement("button", {className: "btn btn-common"}, React.createElement(react_router_1.Link, {to: "/app/" + this.props.params.programId + "/issue/" + this.props.params.issueId + "/report/new"}, "Add report")), React.createElement("button", {className: "btn btn-common"}, React.createElement(react_router_1.Link, {to: "/app/" + this.props.params.programId + "/issue/" + this.props.params.issueId + "/comments/new"}, "Add comment")), React.createElement("button", {className: "btn btn-common"}, React.createElement(react_router_1.Link, {to: "/app/" + this.props.params.programId + "/issue/" + this.props.params.issueId + "/edit"}, "Edit issue")), React.createElement("button", {className: "btn btn-common", onClick: this.watchIssue}, "Watch"))), React.createElement("div", {className: "row"}, React.createElement("div", {className: "col-sm-12"}, React.createElement(react_tabs_1.Tabs, {className: "no-border"}, React.createElement(react_tabs_1.TabList, null, React.createElement(react_tabs_1.Tab, {className: "btn btn-common"}, "Reports"), React.createElement(react_tabs_1.Tab, {className: "btn btn-common"}, "Comments")), React.createElement(react_tabs_1.TabPanel, null, React.createElement("div", {className: "row"}, reports)), React.createElement(react_tabs_1.TabPanel, null, comments))))));
	    }
	}
	exports.Issue = Issue;
	;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  Tabs: __webpack_require__(68),
	  TabList: __webpack_require__(74),
	  Tab: __webpack_require__(73),
	  TabPanel: __webpack_require__(76)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsStylesheet = __webpack_require__(70);
	
	var _jsStylesheet2 = _interopRequireDefault(_jsStylesheet);
	
	var _helpersUuid = __webpack_require__(71);
	
	var _helpersUuid2 = _interopRequireDefault(_helpersUuid);
	
	var _helpersChildrenPropType = __webpack_require__(72);
	...
	module.exports = _react2['default'].createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    if (useDefaultStyles) {
	      (0, _jsStylesheet2['default'])(__webpack_require__(75));
	    }
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsTab = __webpack_require__(73);
	
	var _componentsTab2 = _interopRequireDefault(_componentsTab);
	
	var _componentsTabList = __webpack_require__(74);
...
/***/ function(module, exports, __webpack_require__) {
	...
	class CreateIssueReport extends React.Component {
	    ...
	    componentDidMount() {
	        var self = this;
	        $('select').material_select(); // TODO proper type
	    }
	    addLabel() {
	    ...
	    render() {
	        ...
	        return (React.createElement("div", null, React.createElement("h1", null, "New issue report"), React.createElement("form", {method: "post", onSubmit: this.createIssue}, React.createElement("div", {className: "input-field col s12"}, React.createElement("textarea", {className: "materialize-textarea", placeholder: "Your report", ref: "description"}), React.createElement("label", null, "Description")), React.createElement("div", {className: "input-field col s12"}, React.createElement("textarea", {className: "materialize-textarea", placeholder: "Your computer/software specs", ref: "specs"}), React.createElement("label", null, "Specs")), React.createElement("div", {className: "input-field col s6"}, React.createElement("select", {defaultValue: "", className: "browser-default", ref: "status"}, React.createElement("option", {value: "", disabled: true}), React.createElement("option", {value: "Broken"}, "Broken"), React.createElement("option", {value: "Working"}, "Working"), React.createElement("option", {value: "PartiallyWorking"}, "Partially working"), React.createElement("option", {value: "Works"}, "Works"), React.createElement("option", {value: "NoWork"}, "Does not work")), React.createElement("label", null, "Status")), React.createElement("div", {className: "input-field col s6"}, React.createElement("select", {defaultValue: "", className: "browser-default", ref: "type"}, React.createElement("option", {value: "", disabled: true}), React.createElement("option", {value: "Fix"}, "Fix"), React.createElement("option", {value: "PartialFix"}, "Partial Fix"), React.createElement("option", {value: "Report"}, "Report")), React.createElement("label", null, "Type")), labels, React.createElement("button", {type: "submit", className: "waves-effect waves-light btn"}, "Submit"))));
	    }
	}
